...
dsn_hostname = '172.21.host.x'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='pass'      # e.g. "7dBZ3wWt9XN6$o0J"
...
#CREATE TABLE IF NOT EXISTS sales_data(rowid INTEGER PRIMARY KEY NOT NULL,#product varchar(255) NOT NULL,category varchar(255) NOT NULL,quantity #integer NOT NULL,price decimal DEFAULT 0.0 NOT NULL,
#timeestamp timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL);
